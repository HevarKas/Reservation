    ...
    <div className="max-w-lg mx-auto p-4 space-y-4">
      ...
      <div>
        ...
        <select
          ...
          className={`mt-1 block w-full p-2 border border-gray-300 rounded-md focus:outline-none focus:ring focus:ring-blue-500 ${availableTimeSlots.length === 0 ? 'bg-gray-200 cursor-not-allowed' : ''}`}
        ...
        {availableTimeSlots.length === 0 && <p className="text-red-500 text-sm mt-1">No available times for this date.</p>}
      </div>
    </div>
  );
}
